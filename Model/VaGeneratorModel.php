...
class CMODEL_VA_GENERATOR extends CMODEL_GENERATOR {
  ...
  function get_lower_controller() {
    return $this->_lower_controller;
  }
  function get_upper_controller() {
    return $this->_upper_controller;
  }
  function get_lower_task() {
    return $this->_lower_task;
  }
