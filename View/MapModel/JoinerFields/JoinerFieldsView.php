...
class JoinerFieldsView extends View
{
    ...
    protected $_joinerColumns = array();
    ...
    function init()
    {
        ...
        $joinerColumns = Db::getInstance()->getUtility()->getTableFieldNames($this->post("table"));
        $this->_joinerColumns = array_combine($joinerColumns, $joinerColumns);
        $this->setVar("joinerList", Db::getInstance()->getUtility()->getTableNames());
