...
class DbModelApi extends View {
  ...
  public function exists($response) {
    ...
    $modelExists = class_exists("\\" . $namespace . "\\Model\\" . $pascalName . "Model");
    $handlerExists = class_exists("\\" . $namespace . "\\Handler\\" . $pascalName . "Handler");
    $dboExists = class_exists("\\" . $namespace . "\\Dbo\\" . $pascalName . "Dbo");
    $dbqExists = class_exists("\\" . $namespace . "\\Dbq\\" . $pascalName . "Dbq");
    $traitExists = trait_exists("\\" . $namespace . "\\Model\\Traits\\" . $pascalName . "Trait");

    $response
      ->data("modelExists", $modelExists)
      ->data("handlerExists", $handlerExists)
      ->data("dboExists", $dboExists)
      ->data("traitExists", $traitExists)
      ->data("dbqExists", $dbqExists);
  }
